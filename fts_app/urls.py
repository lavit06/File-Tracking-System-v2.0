...
urlpatterns = [ 
    ...
    # Noting 
    path('dashboard/create-noting/', views.dashboard_views.create_noting, name='create-noting'), 
    path('dashboard/list-notings/', views.dashboard_views.list_notings, name='list-notings'),
    path('dashboard/search-noting/', views.dashboard_views.search_noting, name='search-noting'), 
    path('dashboard/incoming-noting/', views.dashboard_views.incoming_noting, name='incoming-noting'), 
    path('dashboard/forwarded-noting/', views.dashboard_views.forwarded_noting, name='forwarded-noting'), 
    path('dashboard/view-noting/<int:noting_id>/', views.dashboard_views.view_noting, name='view-noting'),
    path('dashboard/view-noting-map/<int:noting_user_map_id>/', views.dashboard_views.view_noting_map, name='view-noting-map'),
    path('dashboard/search-noting-view/<int:noting_id>/', views.dashboard_views.search_noting_view, name='search-noting-view'),     
    ...
    path('backend-admin/search-noting/', views.admin.department_views.search_noting, name='admin-search-noting'),
    path('backend-admin/monitoring-noting/', views.admin.department_views.monitoring_noting, name='admin-monitoring-noting'), 

    path('backend-admin/view-noting-map/<int:noting_user_map_id>/', views.admin.department_views.view_noting_map, name='admin-noting-map'), 
    path('backend-admin/search-noting-view/<int:noting_id>/', views.admin.department_views.search_noting_view, name='admin-search-noting-view'),      
]
